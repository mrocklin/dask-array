...
from dask_array._materialize import _lower, _materialize
...
class Array(DaskMethodsMixin):
    ...
    def __setitem__(self, key, value):
        ...
        # Validate indices and value shape eagerly (before creating the lazy
        # expression) so errors surface at assignment time, not compute time.
        from dask_array.slicing._setitem import parse_and_validate_assignment

        parse_and_validate_assignment(key, self.shape, value.shape)
